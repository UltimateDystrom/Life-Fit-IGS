...
# Images
img_bg = ImageTk.PhotoImage(Image.open('images/Menu1.png'))
...
button_start_training = Button(root, image=img_btn, state= DISABLED, bg='black')
button_start_training.place(x=380, y=150)
...
training = IntVar()
three_minutes = Radiobutton(root, text="3 Minutos", variable=training, value= 1, font=("Yu Gothic", 30), command= lambda: choose_training(training.get()), bg= 'black', fg='white')
five_minutes = Radiobutton(root, text="5 Minutos", variable=training, value= 2, font=("Yu Gothic", 30), command= lambda: choose_training(training.get()), bg= 'black', fg='white')
seven_minutes = Radiobutton(root, text="7 Minutos", variable=training, value= 3, font=("Yu Gothic", 30), command= lambda: choose_training(training.get()), bg= 'black', fg='white')
three_minutes.place(x = 380, y = 400)
five_minutes.place(x=380, y=460)
seven_minutes.place(x=380, y=520)
